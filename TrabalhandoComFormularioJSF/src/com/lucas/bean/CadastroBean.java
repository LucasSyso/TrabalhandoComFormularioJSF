...
/*
 * 
 * Classe que contém as informações da tela de cadastro
 * 
 * */
...
public class CadastroBean implements Serializable{
	...
	//Método que retorna um array com as opções de linguagem que vão aparecer na tela
	...
	/*
	 * 
	 * Método que obtém as linguagens escolhidas pelo usuário e as coloca em uma String
	...
	public String getLinguagensAsString() {
		...
		for(Integer linguagem : linguagens) {
			...
			str += linguagem; //Concatenação de inteiro com String, casting implícito
